...
<body>
    <div class="flex h-screen">
        ...
        <main class="bg-gray-100 flex-1 p-4">
            ...
            <div class="p-8 my-4">
                <h2 class="font-semibold text-2xl">Welcome <span id="patientName">NAME</span>!</h2>
            </div>
            ...
            <div class="p-4">
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="mx-2 gap-72 ">
                        <h3 class="font-semibold mb-4">Upcoming Appointment </h3>


                        <div class="bg-white rounded-lg shadow-md p-4 justify-center">
                            <h1 class="text-xl font-semibold">Appointment Info: <span id="appointmentID"></span> </h2>
                                <h3 class="text-md font-semibold">Room: <span id="roomNo"></span> </h3>
                                <h3 class="text-md font-semibold">Date : <span id="date"></span> </h3>
                                <h3 class="text-md font-semibold">Doctor Name: <span id="docName"></span> </h3>
                        </div>
                    ...
                    <div class="justify-end items-end pb-8">
                        <a href="AddNewAppointment.php"><button class="bg-white rounded-lg shadow-md p-1 justify-end items-end mt-6">+ Add New
                                Appointment</button>
                        </a>
                    </div>
                ...
                <div class="mx-4 mt-10">
                    <h1 class="font-semibold text-3xl">Appointment Records</h1>
                                ...
                                <div class="overflow-hidden">
                                    <table class="min-w-full text-left text-sm font-light">
                                        <thead class="border-b font-medium dark:border-neutral-500">
                                            <tr>
                                                <th scope="col" class="px-6 py-4">Appointment No.</th>

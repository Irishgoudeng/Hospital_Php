...
<body>
    ...
    <div class="flex h-screen">
        ...
        <main class="bg-gray-100 flex-1 p-4">
            ...
            <div class="p-4">
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="mx-2 gap-72 ">
                        <h3 class="font-semibold">Upcoming Appointment </h3>


                        <div class="bg-white rounded-lg shadow-md p-4 justify-center">
                            <h1 class="text-xl font-semibold">Appointment Info: <span id="appointmentID">B34</span> </h2>
                                <h3 class="text-md font-semibold">Room: <span id="roomNo">B34</span> </h3>
                                <h3 class="text-md font-semibold">Date : <span id="date">B34</span> </h3>
                                <h3 class="text-md font-semibold">Doctor Name: <span id="docName">B34</span> </h3>
                        </div>
            ...
            <div class="mx-2 grid grid-cols-2 gap-52 mt-3 ">
